...
server.tool("get_class", "获取彩票的所有分类", async () => {
...
server.tool("get_query", "获取彩票的开奖信息", {
...
server.tool("get_history", "获取彩票的历史开奖信息", {
    caipiaoid: z.string().describe("彩票类型id"),
    issueno: z.string().optional().default("").describe("期号 不填默认是当前期"),
...
server.tool("get_winning", "查询我的号码是否中奖", {
    caipiaoid: z.string().describe("彩票类型id"),
    issueno: z.string().optional().default("").describe("期号 不填默认是当前期"),
